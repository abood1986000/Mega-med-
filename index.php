...
mkdir('data/txt');
mkdir('data/api');
$API_KEY= '7289815578:AAFm3Zqo0xspNjCMwVBj_3auxhOd1t3dxo0';
...
$chall = "TZZQX";
$useradmin = "TITTZI";
$sim =-1002959154793; #القناة الرسمية
$PAY =-1002959154793; #الارقام المكتملة
$ess =-1002959154793; #عمليات شراء الارقام
$eer =-1002959154793; #اشعارات الايميلات وتحويل الروبل
if($chat_id==7170744706){
$sudo=$chat_id;
}elseif($chat_id==7170744706){
$sudo=$chat_id;
}else{
$sudo==7170744706;
}
...
*- في بوت @SIM966* ؛ البوت الأفضل على التليجرام والذي يقوم بتوفير *خدمات الأرقام الوهمية* ل مواقع السوشيال ميديا مثل *التيليجرام والواتساب والتويتر وغيره* 👾
...
- لفحص الرقم, أضغط على زر *رؤية الرقم في واتسأب* بعد شراء الرقم, سيقوم بتوجيهك إلى الواتساب, في حالة قال لك *إن رقم الهاتف هذا +967••• @sim966 ليس في واتسأب* هذا يعني أن الرقم جديد ولم يستخدم في واتسأب من قبل, *أما في الحالات الأخرى فهذا يعني أن الرقم مستخدم في واتسأب ولا نتحمل مسؤولية تفعيلة في أي حال من الأحوال.*
...
'text'=>"
👨‍✈️ *⁞ مرحبا بك* [$first](tg://user?id=$id) ؛
🏛 *⁞ هذه تفاصيل حسابك في بوت. @SIM966* ⬇️
...
'message_id'=>$message_id,
'text'=>"
🧑‍✈️ *- أهلا بك عزيزي العميل* في قسم وكلاء البوت الرسميين في بوت *@SIM966* ☑️
",
'parse_mode'=>"MarkDown",
'reply_markup'=>($keyboad),
]);
